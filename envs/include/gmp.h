...
#define __GMP_CFLAGS "-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /home/james/code/course22/envs/include -fdebug-prefix-map=/opt/conda/conda-bld/gmp_1653996257004/work=/usr/local/src/conda/gmp-6.2.1 -fdebug-prefix-map=/home/james/code/course22/envs=/usr/local/src/conda-prefix"
